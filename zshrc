...
plugins=(git git-open ruby rails rbenv nvm rust docker zsh-syntax-highlighting)
...
if [ -f '/Users/freda/google-cloud-sdk/path.zsh.inc' ]; then . '/Users/freda/google-cloud-sdk/path.zsh.inc'; fi
...
[ -f "/Users/freda/.ghcup/env" ] && source "/Users/freda/.ghcup/env" # ghcup-envexport LDFLAGS="-L/opt/homebrew/opt/llvm@12/lib"
